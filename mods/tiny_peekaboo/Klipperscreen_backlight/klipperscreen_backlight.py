...
button_pin = int(config.get('DEFAULT', 'button_pin', fallback=27))
button_state = GPIO.HIGH if config.get('DEFAULT', 'button_state', fallback='LOW').upper() == 'HIGH' else GPIO.LOW
xinput_id = int(config.get('DEFAULT', 'xinput_id', fallback=6))
